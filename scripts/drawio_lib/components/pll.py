...
from drawio_lib.components.simple_shapes import PLL_LEFT_X, PLL_TIP_X, pll_body
...
_COMPONENT = PllComponent(
    title="pll",
    tags="pll clock drawclock",
    port_mode="both",
    body_svg=pll_body,
    body_margin_x=4,
    port_cells=((_pad + PLL_LEFT_X, _mid), (_pad + PLL_TIP_X, _mid)),
)
