...
from drawio_lib.components.simple_shapes import vdd_body, vdd_port_cell
...
_COMPONENT = ClockSourceComponent(
    title="vdd",
    tags="vdd vcc power tie-high logic1 clock drawclock",
    port_mode="right",
    body_svg=vdd_body,
    body_margin_x=4,
    port_cells=vdd_port_cell(mid_y=_mid, pad=_pad),
