...
from drawio_lib.components.simple_shapes import INV_PORT_LEFT_X, INV_RIGHT_PORT_X, inv_cell_body
...
_COMPONENT = InvComponent(
    title="inv_cell",
    tags="inv_cell inv inverter cell clock drawclock",
    port_mode="both",
    body_svg=inv_cell_body,
