...
BASELINE_CANONICAL_SHA256 = "2a3d6b2696f48e5aef29396dc9812d186b63032b70421b97b53cb34679a62274"
...
def main() -> int:
    ...
    if errors:
        ...
        for error in errors:
            print(f"- {error}")
        return 1
    print("quality contract retention: PASS metrics=25 requirements=25")
    return 0
