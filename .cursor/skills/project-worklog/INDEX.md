...
| --- | --- | --- | --- | --- | --- | --- |
| `drafts/case-generalization-fanout-simulation.md` | draft | active | 2026-09-07 10:24 +08:00 | 2026-09-07 16:14 +08:00 | 举一反三扇出数组模拟 | 新增五轮递归 epoch、R5 再现与后置 owner 根因草稿；等待最终门与发行收敛。 |
| `records/user-feedback-natural-reproduction-gate.md` | record | active | 2026-09-03 13:32 +08:00 | 2026-09-07 16:27 +08:00 | 用户反馈自然复现与防假完成门禁 | 本地最终包与全部机器门闭合；等待提交、远端 Linux/staticx、publish、tag 和回下载。 |
