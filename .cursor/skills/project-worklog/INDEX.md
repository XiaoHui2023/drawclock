...
| --- | --- | --- | --- | --- | --- | --- |
| `records/user-feedback-natural-reproduction-gate.md` | record | active | 2026-09-03 13:32 +08:00 | 2026-09-03 14:53 +08:00 | 用户反馈自然复现与防假完成门禁 | 正式回归 409 通过；本地 pack、gh release 与 CI 发布均强制 release 阶段。 |
| `analysis/user-feedback-reproduction-escape.md` | analysis | active | 2026-09-03 13:32 +08:00 | 2026-09-03 14:31 +08:00 | 人工故障冒充复现与声明逃逸根因 | 定位 structure 阶段误用、CI 缺门与 always 发布旁路。 |
